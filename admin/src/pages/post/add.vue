  ...
  <div class="page-post-add">
    ...
    >
      ...
      <el-form-item prop="pathname">
        <el-input v-model="form.pathname" placeholder="文章路径">
      ...
      <el-form-item prop="cover">
        <div class="page-post-add__picker" @click="showCoverDialog" v-if="form.cover===''">
          <div class="text">文章封面 (推荐 220*100)</div>
        </div>
        <div class="page-post-add__cover" @click="showCoverDialog" v-else>
          <div
      ...
      <el-form-item prop="category">
        ...
        <div slot="error" slot-scope="scope" class="page-post-add__custom-error">{{scope.error}}</div>
      </el-form-item>
      ...
      <el-form-item>
        <el-button type="primary" @click="add(0)">保存文章</el-button>
    ...
    add(published) {
      this.$refs["form"].validate(async valid => {
        if (valid) {
          ...
          const { status } = await services.post.add({
